...
func uiPIDFilePath() string {
	return devswitchDir() + "/ui.pid"
}

func uiLogFilePath() string {
...
Environment variables:
  ...
  DEVSWITCH_UI_BIND_HOST    UI bind host      (default: localhost)       [proxy start]
...
func Execute() error {
	...
	proxyStartCmd.Flags().StringVar(&uiBindHost, "ui-bind", "", "UI bind host (default: localhost)")
	...
	uiServeCmd.Flags().StringVar(&uiBindHost, "bind", "localhost", "UI bind host")
